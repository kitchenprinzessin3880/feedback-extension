var getFeedbackUrl = 'http://ESI.it.csiro.au:8080/csiro-feedback-service/feedback/list';
var postFeedbackUrl = 'http://ESI.it.csiro.au:8080/csiro-feedback-service/feedback/add';
...
var emailTxt = makeTextBox("text", "email", "Email\u00A0\u00A0\u00A0",
		"Contact email", 26);
...
clearelement.setAttribute("type", "reset");
...
window.addEventListener('DOMContentLoaded',
		function() {
			...
			document.getElementById('feedback').addEventListener('submit',
					addFeedback);
			document.getElementById('feedback').addEventListener('reset',
					OnReset);
			...
			chrome.tabs.query({
				...
				/*
				 * ...also specifying a callback to be called from the receiving
				 * end (content script)
				 */
				setDOMInfo);
			});
